export const allPosts = [
  {
    id: 0,
    paylasimResmi: "reactjs.jpg",
    tarih: "30 Mart 2023",
    etiket: "Yazılım",
    baslik: " React  ",
    metin:
      "ReactJS, kullanıcı arayüzü (UI) oluşturmak için bir JavaScript kütüphanesidir. Facebook tarafından geliştirilen React, dinamik ve etkileşimli web uygulamaları oluşturmak için kullanılan bir araçtır.React, uygulama içindeki bileşenleri yönetir ve bu bileşenler, uygulamanın farklı bölümlerinde kullanılabilen yeniden kullanılabilir öğelerdir. Bu bileşenler, JavaScript dilinde yazılan bir kod bloğudur ve özellikleri, durumu ve özyinelemeli işlevleri içerebilirler. React, bileşenlerin yeniden kullanımını sağlar ve bir bileşenin bir kez tanımlandığı ve daha sonra farklı yerlerde kullanılabildiği için, yazılım geliştirme sürecinde zaman ve kaynak tasarrufu sağlar.React, tek yönlü veri akışı kullanır, bu da verinin yalnızca bir yönde hareket ettiği anlamına gelir. Bu, bileşenlerin belirli bir özelliğini veya durumunu değiştirirken, sadece değiştirilen bileşenlerin yeniden oluşturulmasını sağlayarak uygulama performansını artırır.React, birçok diğer JavaScript kütüphanesi veya çerçevesi ile birlikte kullanılabilir ve bu nedenle geniş bir kullanıcı kitlesine sahiptir. Ayrıca, React Native adlı bir versiyonu, mobil uygulamalar için kullanılabilmektedir.",
    paylasanResmi: "ilkanErdogan.png",
    paylasanAdi: "İlkan Erdoğan",
    paylasanUnvan: "Full Stack Developer",
  },
  {
    id: 1,
    paylasimResmi: "reactjs2.jpg",
    tarih: "30 Mart 2023",
    etiket: "Teknoloji",
    baslik: " Next   ",
    metin:
